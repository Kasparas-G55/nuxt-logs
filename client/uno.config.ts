import { defineConfig, presetAttributify, presetIcons, presetTypography, presetWind3, presetWebFonts, transformerDirectives } from 'unocss'
import { unocssPreset as uiKit } from '@nuxt/devtools-ui-kit'
